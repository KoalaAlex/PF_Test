  ...
  return (
    <Divider speed={0.2} offset={0}>
      <UpDown>
        ...
        <SVG icon="triangle" className={blurBig} width={60} stroke="#ff0057" left="10%" top="20%" />
        <SVG icon="imac" className={hidden} width={78} fill="#54e7ff" left="5%" top="15%" />
        <SVG icon="imac" className={hidden + " " + blurBig} width={78} fill="#00dcff" left="5%" top="15%" />
